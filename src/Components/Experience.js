...
function Experience() {
  return (
    <DetailsContainer>
      <PageTitle>Experiências Profissionais</PageTitle>
      <PageContainer>
        <JobDetail
        ...
        >
          <p>
            Uma breve pausa para dedicação a família e a alguns projetos
            pessoais. Fiz viagens, conheci pessoas, países e culturas muito
            diferentes, que me fizeram ter uma visão mais abrangente do mundo.
            Como resultado tive meu blog de viagens montado.
          </p>
        </JobDetail>
        <JobDetail
        ...
        >
          ...
          <p>
            - Levantamento de requisitos juntos aos stakeholders para evoluções
            e correções.
          </p>
          ...
          <p>
            - Atender demandas de ajustes pontuais na base de dados, correções
            de situações urgentes não contempladas pelo novo sistema e geração
            de relatórios gerenciais, usando SQL (SYBASE e Sql Server).
          </p>
        ...
        >
          <p>
            ...
            Informações Previdenciárias (SIPREV), em Delphi, ASP, C++, SQLServer
            e MySQL.
          </p>
        ...
        >
          <p>
            - Ensinar inglês para crianças e adolescentes, em turmas do básico
            ao avançado, incluindo o preparatório para o “FCE - First
        ...
        >
          <p>
            - Dar manutenção no Sistema de Gerenciamento do Programa de
            Prevenção e Tratamento da Aids, do Ministério da Saúde. trabalhando
            com Visual C++ e SYBASE.
          </p>
        </JobDetail>
        <JobDetail
          title="ANALISTA DE REQUISITOS | DESENVOLVEDOR"
        ...
        >
          ...
          <p>
            - Desenvolver pequenos sistemas, usando Delphi e SYBASE, para
            auxiliar nas tarefas internas.
          </p>
        </JobDetail>
        <JobDetail
          title="ANALISTA DE TI | DESENVOLVEDOR"
        ...
        >
          <p>
            - Desenvolver e manter em C++ uma ferramenta de banco de dados
            textual (LightBase for Windows).
          </p>
        </JobDetail>
      </PageContainer>
    </DetailsContainer>
