...
function Training() {
  return (
    <DetailsContainer>
      <PageTitle>Treinamentos Recentes</PageTitle>
      <PageContainer>
        <TrainingDetail
        ...
        <TrainingDetail
          ...
          duration="11 semanas"
        >
          Disciplinas: HTML, CSS, Javascript, Typescript, React, Node.JS,
          GraphQL, Git/Github, Boas Práticas, Metodologia Ágil, DevOps, AWS,
          VTEX IO e soft skills.
        </TrainingDetail>
        <TrainingDetail
